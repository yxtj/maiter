...
if __name__=='__main__':
    if len(sys.argv) <= 4:
        print('Split a delta graph file into parts.')
        print('Usage: <in-file-path> <out-dir> <out-name-prefix> <#parts>')
        print('  <in-file-path>: the path to the input file. The format of the input file is typical delta-graph file format')
